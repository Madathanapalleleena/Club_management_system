...
export function DepartmentDashboard({ dept }) {
  ...
  useEffect(() => { dashAPI.department(dept).then(r=>setData(r.data)).finally(()=>setLoad(false)); }, [dept]);
  ...
  return (
    <div className="page-body">
      <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:4}}>
        ...
        <div><h1 style={{fontSize:'1.4rem',marginBottom:2}}>{meta.label} Dashboard</h1><p style={{color:'var(--text-3)',fontSize:'.875rem'}}>This month · {fmt.date(new Date())}</p></div>
      </div>
