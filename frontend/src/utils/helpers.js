...
export const orderBadge = s => ({ draft:{cls:'badge-muted',label:'Draft'}, approved:{cls:'badge-indigo',label:'Approved'}, dispatched:{cls:'badge-amber',label:'Dispatched'}, delivered:{cls:'badge-green',label:'Delivered'}, cancelled:{cls:'badge-red',label:'Cancelled'} }[s] || {cls:'badge-muted',label:s});
